...
// ═══════════════════════════════════════════════
// 🐳 WP 滑条工具 · Goohai Universal Slider
...
app.registerExtension({
    name: "wp.universal.slider",

    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name !== "WP_UniversalSlider") return;
        ...
        if (
            ...
            LGraphCanvas.prototype.drawNode = function (node, ctx, ...args) {
                if (node.type === "WP_UniversalSlider") {
